...
export default function PatientDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F0FDFA]">
      ...
      <div className="ml-64">
        <TopNavBar patient={MOCK_PATIENT} />
...
function TopNavBar({ patient }: { patient: typeof MOCK_PATIENT }) {
    ...
    <div className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-[1280px] mx-auto px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h1 className="font-playfair text-xl font-bold text-teal-600">CeenAiX</h1>
          <span className="px-2 py-0.5 bg-teal-50 text-teal-600 text-xs rounded-full">Patient Portal</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-600 to-emerald-600 flex items-center justify-center text-white font-sans font-bold text-sm cursor-pointer hover:scale-105 transition-transform">
