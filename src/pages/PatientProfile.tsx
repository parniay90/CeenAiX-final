...
export default function PatientProfile() {
  ...
  function saveSection(msg: string, section?: 'personal' | 'contact' | 'emergency' | 'about') {
    if (!section || section === 'personal') setEditPersonal(false);
    if (!section || section === 'contact') setEditContact(false);
    if (!section || section === 'emergency') setEditEmergency(false);
    if (!section || section === 'about') setEditAbout(false);
          ...
          {!editPersonal ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-2">
                <button onClick={() => saveSection('Personal information updated', 'personal')} className="flex items-center gap-1.5 px-4 py-2 bg-teal-600 text-white rounded-lg text-sm font-medium hover:bg-teal-700 transition-colors">
                  <Save size={14} /> Save
                </button>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          ...
          {!editContact ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-2">
                <button onClick={() => saveSection('Contact details saved', 'contact')} className="flex items-center gap-1.5 px-4 py-2 bg-teal-600 text-white rounded-lg text-sm font-medium hover:bg-teal-700 transition-colors">
                  <Save size={14} /> Save
                </button>
        ...
        <div className="bg-white rounded-2xl shadow-sm border-l-4 border-l-amber-400 border border-slate-100 p-6">
          ...
          {!editEmergency ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-2">
                <button onClick={() => saveSection('Emergency contact updated', 'emergency')} className="flex items-center gap-1.5 px-4 py-2 bg-teal-600 text-white rounded-lg text-sm font-medium hover:bg-teal-700 transition-colors">
                  <Save size={14} /> Save
                </button>
          ...
          {!editAbout ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                <button onClick={() => saveSection('About me saved', 'about')} className="flex items-center gap-1.5 px-4 py-2 bg-teal-600 text-white rounded-lg text-sm font-medium hover:bg-teal-700 transition-colors">
                  <Save size={14} /> Save
                </button>
