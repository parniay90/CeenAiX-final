...
const ACTIONS = [
  { label: 'Review Pre-Auths', icon: <ClipboardList size={20} />, color: '#D97706', bg: '#FEF3C7' },
  { label: 'Bulk Approve', icon: <Check size={20} />, color: '#059669', bg: '#D1FAE5' },
  { label: 'Review Fraud', icon: <Shield size={20} />, color: '#DC2626', bg: '#FEE2E2' },
  { label: 'Generate Report', icon: <BarChart3 size={20} />, color: '#0F2D4A', bg: '#E0E7FF' },
  { label: 'Member Search', icon: <Users size={20} />, color: '#2563EB', bg: '#DBEAFE' },
  { label: 'Provider Query', icon: <Building2 size={20} />, color: '#0D9488', bg: '#CCFBF1' },
];
