...
const SEGMENTS = [
  { name: 'Auto-approved', value: 244, amount: 934200, color: '#0D9488', label: '✅ Auto-approved' },
  { name: 'Pending', value: 42, amount: 201640, color: '#D97706', label: '⏳ Pending' },
  { name: 'Denied', value: 18, amount: 72800, color: '#DC2626', label: '❌ Denied' },
  { name: 'Appealed', value: 8, amount: 39200, color: '#7C3AED', label: '⚖ Appealed' },
];
  ...
  return (
    <div className="bg-white rounded-2xl p-5" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.07)' }}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="font-bold" style={{ fontFamily: 'DM Mono, monospace', fontSize: 13, color: '#059669' }}>
          AED 1,247,840 total
        </span>
      </div>
