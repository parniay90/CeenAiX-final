...
import { GitBranch, AlertTriangle, ClipboardList, Dna, Users, Info, ChevronUp, ChevronDown } from 'lucide-react';
import {
  MOCK_FAMILY_MEMBERS,
...
export default function FamilyHistoryTab() {
  // Only Genetic Conditions & Clinical Notes open by default
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <SectionHeader
          sectionKey="family-members"
          icon={<Users className="w-5 h-5 text-teal-600" />}
          title="Family Members & Their Conditions"
          subtitle="Known medical history by family member"
          badge={
      ...
      {/* Section 2 — Hereditary Risk Assessment */}
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <SectionHeader
          sectionKey="risk-assessment"
          icon={<GitBranch className="w-5 h-5 text-teal-600" />}
          title="Hereditary Risk Assessment"
          subtitle="Estimated risk based on family history patterns"
        />
        {openSections['risk-assessment'] && (
      ...
      {/* Section 3 — Genetic Conditions & Clinical Notes */}
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <SectionHeader
          sectionKey="genetic-notes"
          icon={<Dna className="w-5 h-5 text-teal-600" />}
          title="Genetic Conditions & Clinical Notes"
          subtitle="Physician-recorded notes and genetic flags"
        />
        {openSections['genetic-notes'] && (
          <div className="px-6 py-6 space-y-5 border-t border-gray-100">
