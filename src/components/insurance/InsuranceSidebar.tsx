import { LayoutDashboard, FileCheck, Receipt, HeartPulse, TrendingUp, Building2, Shield, Settings, LogOut } from 'lucide-react';
    ...
    <div className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
      ...
      <div className="p-4 border-t border-slate-800 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-slate-400 hover:bg-red-900/20 hover:text-red-400 transition-colors text-sm"
        >
